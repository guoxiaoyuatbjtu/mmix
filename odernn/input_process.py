...
data = np.load(open(f'../data/complete/{dataset}.npy', 'rb'))
masks = np.load(open(f'../data/mask/{dataset}_Pattern{pattern}.npy', 'rb'))
...
fs = open(f'json/{dataset}_Pattern{pattern}.json', 'w')
