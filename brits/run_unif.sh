CUDA_VISIBLE_DEVICES=0 python main.py --epochs 500 --input_size 170 --batch_size 256 --seq_len 48 --hid_size 128 --data PEMS08 --pattern PatternB --aug unif --rate 0.1
...
CUDA_VISIBLE_DEVICES=0 python main.py --epochs 500 --input_size 170 --batch_size 256 --seq_len 48 --hid_size 128 --data PEMS08 --pattern PatternC --aug unif --rate 0.1
