...
# python main.py --model brits --epochs 2000 --batch_size 64 --hid_size 108
...
def run():
    model = brits.Model(args.input_size, args.seq_len, args.hid_size, args.aug, {'k': args.k, 'rate': args.rate, 'seed': seed})
